export const content = {
  en: {
    ...
    hero: {
      ...
      stats: [
        ...
        { value: "99.9%", label: "Uptime on automations" },
      ...
      items: [
        {
          ...
          desc: "Connect your existing tools with n8n or Zapier. One integration, immediate results. EHR to billing, scheduling to CRM — done in days.",
        },
        {
          icon: "Layers",
          title: "Complex Connected Systems",
          desc: "Multi-step workflows with conditional logic across platforms. Patient intake, referral routing, insurance verification — all automated.",
        },
        {
          icon: "Brain",
          title: "LLM + AI Integration",
          desc: "Large language models integrated into your workflows with basic training and fine-tuning. Intelligent triage, document summarization, patient communication.",
        },
        {
          icon: "Eye",
          title: "Monitoring & Support",
          desc: "Visual dashboards to track every automation in real time. Proactive alerts, performance metrics, and dedicated support.",
        },
        {
          icon: "MapPin",
          title: "Process Mapping Sessions",
          desc: "We sit with your team to map every workflow, find bottlenecks, and design the automation roadmap that delivers ROI fastest.",
        },
        {
          icon: "ShieldCheck",
          title: "Compliance First",
          desc: "Every automation is built with HIPAA (U.S.) and Ley 1581 Habeas Data (Colombia) compliance baked in. No exceptions.",
        },
      ],
    },
    process: {
      ...
      steps: [
        {
          ...
          desc: "We analyze your current workflows, identify bottlenecks, and map out exactly where automation will save you the most time and money.",
        },
        {
          num: "02",
          title: "Build & Deploy",
          desc: "Our team builds your custom automations, integrates them with your existing tools (EHR, CRM, billing), and deploys with zero disruption to your operations.",
        },
        {
          num: "03",
          title: "Monitor & Scale",
          desc: "Real-time dashboards track performance. We continuously optimize, handle maintenance, and scale your automations as your practice grows.",
        },
      ],
    },
    why: {
      ...
      points: [
        {
          icon: "ShieldCheck",
          title: "HIPAA & Data Privacy First",
          desc: "Every workflow is designed with PHI protection, encryption standards, and audit trails built in from day one.",
        },
        {
          icon: "Clock",
          title: "Save 15+ Hours per Week",
          desc: "Clinics using our automations redirect staff time from data entry and manual tasks to patient care.",
        },
        {
          icon: "DollarSign",
          title: "Reduce Operational Costs",
          desc: "Fewer errors, faster billing cycles, and less manual labor translate directly to your bottom line.",
        },
        {
          icon: "Activity",
          title: "Dual Market Expertise",
          desc: "We serve clinics in the U.S. (HIPAA) and Colombia (Ley 1581 / Habeas Data) with localized compliance knowledge.",
        },
      ],
      compliance: {
  ...
  es: {
      ...
      items: [
        {
          ...
          desc: "Conecta tus herramientas con n8n o Zapier. Una integración, resultados inmediatos. EHR a facturación, agendamiento a CRM — listo en días.",
        },
        {
          icon: "Layers",
          title: "Sistemas Conectados Complejos",
          desc: "Flujos multi-paso con lógica condicional entre plataformas. Admisión de pacientes, enrutamiento de referidos, verificación de seguros — todo automatizado.",
        },
        {
          icon: "Brain",
          title: "LLM + Integración IA",
          desc: "Modelos de lenguaje integrados a tus flujos con entrenamiento básico y fine-tuning. Triage inteligente, resumen de documentos, comunicación con pacientes.",
        },
        {
          icon: "Eye",
          title: "Monitoreo y Soporte",
          desc: "Dashboards visuales para rastrear cada automatización en tiempo real. Alertas proactivas, métricas de rendimiento y soporte dedicado.",
        },
        {
          icon: "MapPin",
          title: "Sesiones de Mapeo de Procesos",
          desc: "Nos sentamos con tu equipo a mapear cada flujo, encontrar cuellos de botella y diseñar la hoja de ruta que genera ROI más rápido.",
        },
        {
          icon: "ShieldCheck",
          title: "Cumplimiento Primero",
          desc: "Cada automatización se construye con cumplimiento HIPAA (EE.UU.) y Ley 1581 Habeas Data (Colombia) integrado. Sin excepciones.",
        },
      ],
    },
    process: {
      ...
      steps: [
        {
          num: "01",
          title: "Descubrimiento y Mapeo",
          desc: "Analizamos tus flujos actuales, identificamos cuellos de botella y mapeamos exactamente dónde la automatización te ahorrará más tiempo y dinero.",
        },
        {
          num: "02",
          title: "Construcción y Despliegue",
          desc: "Nuestro equipo construye tus automatizaciones, las integra con tus herramientas (EHR, CRM, facturación) y despliega sin interrumpir tus operaciones.",
        },
        {
          num: "03",
          title: "Monitoreo y Escalamiento",
          desc: "Dashboards en tiempo real rastrean el rendimiento. Optimizamos continuamente, manejamos mantenimiento y escalamos tus automatizaciones conforme creces.",
        },
      ],
    },
    why: {
      ...
      points: [
        {
          icon: "ShieldCheck",
          title: "HIPAA y Privacidad Primero",
          desc: "Cada flujo se diseña con protección de PHI, estándares de encripción y trazabilidad desde el día uno.",
        },
        {
          icon: "Clock",
          title: "Ahorra 15+ Horas por Semana",
          desc: "Clínicas usando nuestras automatizaciones redirigen tiempo de staff de tareas manuales al cuidado del paciente.",
        },
        {
          icon: "DollarSign",
          title: "Reduce Costos Operativos",
          desc: "Menos errores, ciclos de facturación más rápidos y menos labor manual se traducen directo a tu resultado final.",
        },
        {
          icon: "Activity",
          title: "Experiencia en Dos Mercados",
          desc: "Servimos clínicas en EE.UU. (HIPAA) y Colombia (Ley 1581 / Habeas Data) con conocimiento regulatorio localizado.",
        },
      ],
      compliance: {
    ...
    cta: {
      ...
      button: "Agenda Tu Llamada Gratis",
      ...
      fields: {
        ...
        message: "¿Cuál es tu mayor desafío operativo?",
