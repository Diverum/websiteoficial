...
export const countryStories = {
  US: {
    en: {
      heroTag: "Healthcare Automation — HIPAA Compliant",
      ...
      complianceService: "Every automation is built with HIPAA compliance baked in — PHI protection, encryption, and audit trails. No exceptions.",
      privacyTitle: "HIPAA & Data Privacy First",
      privacyDesc: "Every workflow is designed with PHI protection, encryption standards, and audit trails built in from day one.",
      expertiseTitle: "U.S. Healthcare Expertise",
      expertiseDesc: "We specialize in U.S. healthcare regulations, including HIPAA, ensuring every automation meets federal compliance standards.",
      ctaBenefit: "HIPAA-compliant process",
      footerBadge: "HIPAA Compliant",
    },
    es: {
      heroTag: "Automatización Healthcare — Cumplimiento HIPAA",
      ...
      complianceService: "Cada automatización se construye con cumplimiento HIPAA integrado — protección de PHI, encripción y trazabilidad. Sin excepciones.",
      privacyTitle: "HIPAA y Privacidad Primero",
      privacyDesc: "Cada flujo se diseña con protección de PHI, estándares de encripción y trazabilidad desde el día uno.",
      expertiseTitle: "Experiencia en Salud en EE.UU.",
      expertiseDesc: "Nos especializamos en regulaciones de salud de EE.UU., incluyendo HIPAA, asegurando cumplimiento federal en cada automatización.",
      ctaBenefit: "Proceso con cumplimiento HIPAA",
      footerBadge: "Cumplimiento HIPAA",
    },
  },
  CO: {
    en: {
      heroTag: "Healthcare Automation — Ley 1581 Compliant",
      ...
      complianceService: "Every automation is built with Ley 1581 / Habeas Data compliance baked in — consent management, data minimization, and subject rights. No exceptions.",
      privacyTitle: "Ley 1581 & Data Privacy First",
      privacyDesc: "Every workflow is designed with personal data protection, consent management, and regulatory compliance built in from day one.",
      expertiseTitle: "Colombian Healthcare Expertise",
      expertiseDesc: "We specialize in Colombian healthcare regulations, including Ley 1581 / Habeas Data, ensuring every automation meets local compliance standards.",
      ctaBenefit: "Ley 1581 compliant process",
      footerBadge: "Ley 1581 Compliant",
    },
    es: {
      heroTag: "Automatización Healthcare — Cumplimiento Ley 1581",
      ...
      complianceService: "Cada automatización se construye con cumplimiento Ley 1581 / Habeas Data integrado — gestión de consentimiento, minimización de datos y derechos del titular. Sin excepciones.",
      privacyTitle: "Ley 1581 y Privacidad Primero",
      privacyDesc: "Cada flujo se diseña con protección de datos personales, gestión de consentimiento y cumplimiento regulatorio desde el día uno.",
      expertiseTitle: "Experiencia en Salud en Colombia",
